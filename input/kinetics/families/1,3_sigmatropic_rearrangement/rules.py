...
entry(
    index = 1,
    label = "Sigma_Root",
    kinetics = ArrheniusBM(A=(3.11403e+20,'s^-1'), n=-1.91643, w0=(671167,'J/mol'), E0=(227910,'J/mol'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.2489853322397734, var=103.35155747037187, Tref=1000.0, N=24, data_mean=0.0, correlation='Sigma_Root',), comment="""BM rule fitted to 24 training reactions at node Root
