...
entry(
    ...
    rank = 5,
    shortDesc = u"""Calculated at CBS-QB3 + 1DSHR by Xiaorui Dong (RMG GitHub)""",
    longDesc =
"""
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: MPO1Q2J <=> MPO12OCYC + OH
""",
)

entry(
    index = 73,
    label = "C4H9O3-9 <=> C4H8O2-9 + OH",
    degeneracy = 1.0,
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: MPO1Q3J <=> MPO13OCYC + OH
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: MPO1Q-1QJ <=> Ozoind1-1 + OH
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: MPO1Q3QJ <=> Ozoind13 + OH
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: MPO1Q2J-1Q <=> MPO1Q2-1OCYC + OH
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: MPO1Q2J-1Q <=> MPO-1Q12OCYC + OH
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: MPO1Q2J3Q <=> MPO1Q23OCYC + OH
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: MPO1Q2J3Q <=> MPO3Q12OCYC + OH
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: dOCCCOO <=> OH + C1COOC1
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: [CH2]CC(OO)=O <=> C1CC(O1)=O + OH
CBS-QB3
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: CC(OO)[C]=O <=> CC1OC1=O + OH
CBS-QB3
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: C(OO)C[C]=O <=> C1CC(O1)=O + OH
CBS-QB3
""",
)
...
entry(
    ...
    longDesc =
"""
Johnson et al., Oxidation and pyrolysis of methyl propyl ether, 2021, 10.1002/kin.21489Original entry: [CH2]COO <=> C1OC1 + OH
CBS-QB3
""",
)
...
entry(
    ...
    rank = 3,
    shortDesc = """Sakai et al 2017, Sakai:PCI35(2015)161-169:pQOOH14hs:*rc""",
    longDesc = 
"""
Original entry: C4H8OaOOHb <=> C4H8OcyOab + OH
""",
)
...
entry(
    ...
    rank = 3,
    shortDesc = """Sakai et al 2017, Sakai:PCI35(2015)161-169:pQOOH16hs:*rc""",
    longDesc = 
"""
Original entry: C4H8OaOOHc <=> C4H8OcyOac + OH
""",
)
...
entry(
    ...
    longDesc = 
"""
Original entry: C4H8OaOOHd <=> C4H8OcyOad + OH
""",
)

entry(
    index = 88,
    label = "C4H9O3-4 <=> C4H8O2-4 + OH",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(6.14e+11,'s^-1'), n=0.2, Ea=(19927.7,'cal/mol'), T0=(1,'K')),
    rank = 3,
    shortDesc = """Sakai et al 2017, Sakai:PCI35(2015)161-169:sQOOH15hs:rc""",
    longDesc = 
"""
Original entry: C4H8ObOOHc <=> C4H8OcyObc + OH
""",
)

entry(
    index = 89,
    label = "C4H9O3-5 <=> C4H8O2-5 + OH",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(3.68e+10,'s^-1'), n=0.27, Ea=(14927.7,'cal/mol'), T0=(1,'K')),
    rank = 3,
    shortDesc = """Sakai et al 2017, Sakai:PCI35(2015)161-169:sQOOH16hs:*rc""",
    longDesc = 
"""
Original entry: C4H8ObOOHd <=> C4H8OcyOac + OH
""",
)

entry(
    index = 90,
    label = "C4H9O3-6 <=> C4H8O2-6 + OH",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(6.07e+10,'s^-1'), n=0.63, Ea=(12036.5,'cal/mol'), T0=(1,'K')),
    rank = 3,
    shortDesc = """Sakai et al 2017, Sakai:PCI35(2015)161-169:sQOOH14hs:*rc""",
    longDesc = 
"""
Original entry: C4H8ObOOHa <=> C4H8OcyOab + OH
""",
)

entry(
    index = 91,
    label = "C4H9O5-7 <=> C4H8O4-7 + OH",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(3.97e+09,'s^-1'), n=0.73, Ea=(9377.6,'cal/mol'), T0=(1,'K')),
    rank = 3,
    shortDesc = """Sakai et al 2017, Sakai:PCI35(2015)161-169:pQOOH16hs:*rc""",
    longDesc = 
"""
Original entry: bC4H7OcdOOH <=> C4H8ObOOHcyOac + OH
""",
)

entry(
    index = 92,
    label = "C4H9O5-8 <=> C4H8O4-8 + OH",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(8.12e+10,'s^-1'), n=0.6, Ea=(10003.6,'cal/mol'), T0=(1,'K')),
    rank = 3,
    shortDesc = """Sakai et al 2017, Sakai:PCI35(2015)161-169:pQOOH14hs:*rc""",
    longDesc = 
"""
Original entry: bC4H7OacOOH <=> C4H8OcOOHcyOab + OH
""",
)

entry(
    index = 93,
    label = "C4H9O5-9 <=> C4H8O4-9 + OH",
    degeneracy = 1.0,
    kinetics = Arrhenius(A=(8.12e+10,'s^-1'), n=0.6, Ea=(10003.6,'cal/mol'), T0=(1,'K')),
    rank = 3,
    shortDesc = """Sakai et al 2017, Sakai:PCI35(2015)161-169:pQOOH14hs:*rc""",
    longDesc = 
"""
Original entry: bC4H7OadOOH <=> C4H8OdOOHcyOab + OH
""",
)
